		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pet Shop - Orders",
									"targetURL": "#petshopzppetshoporders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"petshopzppetshoporders-display": {
								"semanticObject": "petshopzppetshoporders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=petshop.zppetshoporders",
									"url": sap.ui.require.toUrl("petshop/zppetshoporders")
								}
							}
						}
					}
